...
func TestUnmarshalTimeSeries(t *testing.T) {
	f := func(src []byte, wantTSS []TimeSeries) {
		...
		tss, _, _, err = unmarshalTimeSeries(src, tss, nil, nil)
		if err != nil {
	...
	// classic time series with samples, no histogram
	{
		src := encodeTimeSeries(
			[]labelPair{{name: "__name__", value: "rpc_latency_seconds"}, {name: "job", value: "node-exporter"}},
			[]samplePair{{value: 1.5, timestamp: 5000}},
			nil,
		)
		f(src, []TimeSeries{
			{
	...
	// basic positive histogram
	{
		...
		f(src, []TimeSeries{
			...
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(-0.00001, 0.00001)}},
				Samples: []Sample{{Value: 2, Timestamp: 1000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(0.5, 1)}},
				Samples: []Sample{{Value: 2, Timestamp: 1000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(1, 2)}},
				Samples: []Sample{{Value: 1, Timestamp: 1000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(2, 4)}},
				Samples: []Sample{{Value: 3, Timestamp: 1000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(4, 8)}},
				Samples: []Sample{{Value: 2, Timestamp: 1000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "job", Value: "node-exporter"}, {Name: "vmrange", Value: formatVmrange(32, 64)}},
				Samples: []Sample{{Value: 3, Timestamp: 1000}},
			},
		})
	}
	...
	// basic negative histogram
	{
		...
		src := encodeTimeSeries(
			[]labelPair{{name: "__name__", value: "rpc_latency_seconds"}},
			nil,
			[][]byte{histogram},
		)
		f(src, []TimeSeries{
			...
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "vmrange", Value: formatVmrange(-2, -1)}},
				Samples: []Sample{{Value: 3, Timestamp: 2000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "vmrange", Value: formatVmrange(-4, -2)}},
	...
	// float histogram
	{
		...
		f(src, []TimeSeries{
			...
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "vmrange", Value: formatVmrange(-0.00001, 0.00001)}},
				Samples: []Sample{{Value: 0.5, Timestamp: 3000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "vmrange", Value: formatVmrange(0.7071, 1)}},
				Samples: []Sample{{Value: 1.5, Timestamp: 3000}},
			},
			{
				Labels:  []Label{{Name: "__name__", Value: "rpc_latency_seconds_bucket"}, {Name: "vmrange", Value: formatVmrange(1, 1.414)}},
				Samples: []Sample{{Value: 1.0, Timestamp: 3000}},
			},
		})
	}
...
func encodeTimeSeries(labels []labelPair, samples []samplePair, histograms [][]byte) []byte {
	var dst []byte
